...
// Accedemos al botón calcular por medio de la API DOM
const btnCalcular = document.querySelector("#idBtnCalcular");

// Agregamos el evento click al botón calcular y le asignamos la función que realizará la operación
...
function calcularTabla() {
    ...
    if (inputTabla > 0) {
        ...
        // Utilizamos do while para generar la tabla de multiplicar que el usuario ha indicado
        do {
