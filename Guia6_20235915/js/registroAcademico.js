document.addEventListener("DOMContentLoaded", function () {
    ...
    // Agregamos el evento click a los botones y le asignamos la función que realizará la operación
    btnAddEstudiante.addEventListener("click", addEstudiantes);
    btnViewEstudiantes.addEventListener("click", viewEstudiantes);

    // Arreglo de estudiantes de forma global
    let arrayEstudiantes = [];

    // Creando función para agregar estudiantes
    ...
    function viewEstudiantes() {
        ...
        if (totalEstudiantes > 0) {
            ...
            // Utilizamos un bucle for para recorrer el arreglo de estudiantes
